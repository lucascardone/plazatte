...
function HomeScreen() {
   ...
   return (
      <div className="position-relative">
         <div className="position-absolute w-100" style={{ top: '-68%', left: '8%', overflow: 'visible', pointerEvents: 'none', zIndex: 5 }}>
            <svg width="500px" height="500" viewBox="0 0 600 300" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'translateY(-50px)' }}>
